...
function AdminHeader({ setOpen }) {
    ...
    return (
        <header className="flex items-cent justify-between px-4 py-3 bg-backgraound border-b">
            ...
            <Button onClick={handleLogout} className="inline-flex gap-2 items-center rounded-md px-4 py-2 text-sm font-medium shadow bg-black text-white font-semibold">
